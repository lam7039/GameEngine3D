...
namespace se {
	...
	public:
		...
		~Debug();
		///
		/// Log an error with a warning level (ErrorType), the file the error is in which is usually given __FILE__, the line which is usually given __LINE__, and the message it's supposed to write.
		///
