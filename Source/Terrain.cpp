...
namespace se {
	...
	Terrain::Terrain() {
		...
		Direct3D::GetDevice()->CreateVertexBuffer(WIDTH * HEIGHT * sizeof(Vertex), 0, D3DFVF_XYZ | D3DFVF_DIFFUSE, D3DPOOL_DEFAULT, &m_vertexBuffer, NULL);
		...
		Direct3D::GetDevice()->CreateIndexBuffer((WIDTH - 1) * (HEIGHT - 1) * 6 * sizeof(short), D3DUSAGE_WRITEONLY, D3DFMT_INDEX16, D3DPOOL_MANAGED, &m_indexBuffer, NULL);
	...
	void Terrain::Render() {
		...
		Direct3D::GetDevice()->SetFVF(D3DFVF_XYZ | D3DFVF_DIFFUSE);
